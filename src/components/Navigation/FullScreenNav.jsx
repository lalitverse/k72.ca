...
const FullScreenNav = () => {
    ...
    return (
        <div ref={fullScreenRef} id='fullscreennav' className='fullscreennav hidden text-white overflow-hidden h-[100dvh] w-full z-50 fixed top-0 left-0'>
            ...
            <div ref={fullNavLinksRef} className='relative'>
                ...
                <div className=' py-36'>
                    <div className='link origin-top relative border-t-1 border-white'>
                        <Link to='/projects' onClick={() => setNavOpen(false)}><h1 className='font-[font2] text-5xl lg:text-[8vw] text-center lg:leading-[0.8] lg:pt-10 pt-3 uppercase'>Projets</h1></Link>
                        <div className='moveLink absolute text-black flex top-0 bg-[#D3FD50] pointer-events-none'>
                    ...
                    <div className='link origin-top relative border-t-1 border-white'>
                        <Link to='/agence' onClick={() => setNavOpen(false)}><h1 className='font-[font2] text-5xl lg:text-[8vw] text-center lg:leading-[0.8] lg:pt-10 pt-3 uppercase'>Agence</h1></Link>
                        <div className='moveLink absolute text-black flex top-0 bg-[#D3FD50] pointer-events-none'>
                            <div className='moveX flex items-center'>
                                <h2 className='whitespace-nowrap font-[font2] lg:text-[8vw] text-5xl  text-center lg:leading-[0.8] lg:pt-10 pt-4 uppercase'>Pour Tout voir</h2>
                                <img className='lg:h-36 h-14 rounded-full shrink-0 lg:w-96 w-32 object-cover' src="https://k72.ca/uploads/caseStudies/WIDESCAPE/WS---K72.ca---MenuThumbnail-640x290.jpg" alt="" />
                    ...
                    <div className='link origin-top relative border-t-1 border-white'>
                        <Link to='/contact' onClick={() => setNavOpen(false)}><h1 className='font-[font2] text-5xl lg:text-[8vw] text-center lg:leading-[0.8] lg:pt-10 pt-3 uppercase'>Contact</h1></Link>
                        <div className='moveLink absolute text-black flex top-0 bg-[#D3FD50] pointer-events-none'>
                            <div className='moveX flex items-center'>
                                <h2 className='whitespace-nowrap font-[font2] lg:text-[8vw] text-5xl  text-center lg:leading-[0.8] lg:pt-10 pt-4 uppercase'>Pour Tout voir</h2>
                                <img className='lg:h-36 h-14 rounded-full shrink-0 lg:w-96 w-32 object-cover' src="https://k72.ca/uploads/caseStudies/WIDESCAPE/WS---K72.ca---MenuThumbnail-640x290.jpg" alt="" />
                    ...
                    <div className='link origin-top relative border-y-1 border-white'>
                        <Link to='/blogue' onClick={() => setNavOpen(false)}><h1 className='font-[font2] text-5xl lg:text-[8vw] text-center lg:leading-[0.8] lg:pt-10 pt-3 uppercase'>Blogue</h1></Link>
                        <div className='moveLink absolute text-black flex top-0 bg-[#D3FD50] pointer-events-none'>
                            <div className='moveX flex items-center'>
                                <h2 className='whitespace-nowrap font-[font2] lg:text-[8vw] text-5xl  text-center lg:leading-[0.8] lg:pt-10 pt-4 uppercase'>Pour Tout voir</h2>
                                <img className='lg:h-36 h-14 rounded-full shrink-0 lg:w-96 w-32 object-cover' src="https://k72.ca/uploads/caseStudies/WIDESCAPE/WS---K72.ca---MenuThumbnail-640x290.jpg" alt="" />
